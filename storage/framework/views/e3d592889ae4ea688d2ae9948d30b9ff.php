                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_laporan" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $laporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id_laporan); ?>"><?php echo e($item->nama_barang); ?></option>
...
</html><?php /**PATH C:\Users\Uli Ketan\Downloads\temuin (2)\temuin\resources\views/v_klaim/tambah.blade.php ENDPATH**/ ?>